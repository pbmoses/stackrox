            ...
            <List isPlain data-testid="deployment-legend">
                ...
                {UIfeatureFlags.SHOW_DISALLOWED_CONNECTIONS && (
                    <LegendTile
                        ...
                        description="Disallowed deployment (no connections allowed)"
                    />
                )}
            </List>
            ...
            <List isPlain data-testid="namespace-legend">
                ...
                {UIfeatureFlags.SHOW_DISALLOWED_CONNECTIONS && (
                    <LegendTile
                        ...
                        description="Active but disallowed namespace connection"
                    />
                )}
            </List>
            <Divider component="div" className="pf-u-py-sm" />
            <List isPlain data-testid="connection-legend">
                ...
                {UIfeatureFlags.SHOW_DISALLOWED_CONNECTIONS && (
                    <LegendTile
                        ...
                        description="Active but disallowed connection"
                    />
                )}
                <LegendTile
        ...
        >
            ...
            {!isOpen && (
                <Button
                    ...
                    tabIndex={0}
                    variant={ButtonVariant.plain}
                    className="pf-u-font-family-heading-sans-serif pf-u-color-300"
                >
                    Legend
                </Button>
            )}
