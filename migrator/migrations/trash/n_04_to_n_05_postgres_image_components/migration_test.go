...
func (s *postgresMigrationSuite) TearDownTest() {
	...
	_ = s.gormDB.Migrator().DropTable(pkgSchema.CreateTableImageComponentsStmt.GormModel)
	pgtest.CleanUpDB(s.ctx, s.T(), s.pool)
...
func (s *postgresMigrationSuite) TestMigration() {
	...
	for _, imageComponent := range imageComponents {
		s.Equal(imageComponent, s.get(imageComponent.GetId()))
	}
}

func (s *postgresMigrationSuite) get(id string) *storage.ImageComponent {
